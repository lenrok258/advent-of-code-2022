...
def valid_actions(bprint_nr, res, robos, minute):
    ...
    # if you have enought res to produce geo robo every turn, do not build any other robots other then geo robo
    ...
    # in 31 minute, even if we create a roto it will not produce anything 
    if minute == 31:
        return [0]
...
geo_max_all = []
for i, b in enumerate(blueprints[:4]):
...
print(geo_max_all[0] * geo_max_all[1] * geo_max_all[2])
